...
// woff2 subsets are inlined as base64 at build time and decoded once here, then
// served from memory. That keeps the one-file deploy intact and, more to the
...
import serifB64 from "./assets/instrument-serif-400.woff2";
import sansB64 from "./assets/geist-var.woff2";
import monoB64 from "./assets/geist-mono-var.woff2";
...
export const FONTS: Record<string, Font> = {
  serif: font("instrument-serif", serifB64),
  sans: font("geist", sansB64),
  mono: font("geist-mono", monoB64),
};
